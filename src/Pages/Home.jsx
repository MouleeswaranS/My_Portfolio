...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/MouleeswaranS " },
  { icon: Linkedin, link: "https://linkedin.com/in/mouleeswarans2005/" },
  { icon: Instagram, link: "https://www.instagram.com/moulee22_12/" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-8 xl:px-12 min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 lg:ml-12 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200"
            >
